...
/**
  Helps read parameters and save input stream from multipart forms
*/
...
public class MultipartHelper
{
  ...
  */
  ...
  public void go( ServletRequest request )
    throws IOException
  {
    go( request.getInputStream(), request.getContentType(), request.getContentLength() );
  }

  public void go( InputStream in, String contentTypeText, int contentLength )
    throws IOException
  {
    debug( "contentTypeText : " + contentTypeText );
    if ( (contentTypeText != null) &&
      (contentTypeText.startsWith("multipart/form-data")) &&
